    ...
    seed: (req, res) => {
        sequelize.query(`
            ...
            INSERT INTO venues ( venue_name, type, details, author, image_url, website_url, likes) 
                ...
                ( 'The Venetian', 'Hotel', 'Top notch everything. I love to shop and I enjoyed the gondola with my hubs. Had a blast!', 'missTERY', 'https://i.ibb.co/qNKqWpQ/venetian.jpg', 'https://www.venetianlasvegas.com/', 0);
